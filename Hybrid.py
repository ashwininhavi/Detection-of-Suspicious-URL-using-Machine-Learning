...
def load_data():
    ...
    training_inputs = inputs[:500]       #  Select first 1500 rows (0-1499) excluding last column
    training_outputs = outputs[:500]     #  Select first 1500 rows (0-1499) with only last column
    testing_inputs = inputs[1000:]		  #  Select remaining rows (1500-2455) excluding last column
    testing_outputs = outputs[1000:]      #  Select remaining rows (1500-2455) with only last column
...
if __name__ == '__main__':        # Entry point of the program
    ...
    print ("The accuracy of your Hybrid classifier on testing data is: " + str(round(accuracy,2))+ "%")
    print("confusion matrix=\n",confusionmatrix)
	
    error=(1-accuracy/100.0)*100.0
    print("The error rate of the Hybrid classifier on testing data is: " + str(round(error,2)) + "%")
