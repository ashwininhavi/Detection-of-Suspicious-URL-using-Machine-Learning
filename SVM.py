...
if __name__ == '__main__':        # Entry point of the program
    ...
    print ("The accuracy of your SVM classifier on testing data is: " + str(round(accuracy,2))+ "%")
    print("confusion matrix=\n",confusionmatrix)
	
    error=(1-accuracy/100.0)*100.0
    print("The error rate of the SVM classifier on testing data is: " + str(round(error,2)) + "%")
